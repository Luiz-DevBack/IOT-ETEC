...
- Emissão de faltas automáticas com base no tempo de ausência.
...
### Pré-requisitos
- Arduino IDE instalada ([Baixar aqui](https://www.arduino.cc/en/software))
- Leitor RFID e Tags

### Passo a Passo
1. Clone o repositório:
   ```bash
   git clone https://github.com/Luiz-DevBack/IOT-ETEC.git
Configure o hardware conforme o diagrama na pasta docs.
...
Carregue o código no Arduino.
🔧 Como Usar
Passe a tag RFID pelo leitor para registrar a entrada.
O sistema automaticamente registrará a presença e exibirá no painel.
🤝 Como Contribuir
